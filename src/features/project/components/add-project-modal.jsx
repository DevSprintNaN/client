                    ...
                    <div className="relative overflow-hidden rounded-md bg-white text-left shadow-xl transition-all md:max-w-6xl">
                        ...
                        <form className="space-y-4 p-4 sm:p-10 " onSubmit={handleSubmit}>
                            ...
                            <div className='flex items-center justify-between px-2'>
                                ...
                                <button type="submit" className={`md:w-1/2 bg-purple-700 text-white py-2 px-4 rounded-md hover:bg-purple-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900 transition-colors duration-300 ${disabled ? "opacity-50" : ""}`}>Confirm</button>
                            </div>
                        </form>
                    </div>
                </div>
